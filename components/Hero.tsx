...
const Hero: React.FC<HeroProps> = ({ headline, subtext, buttonText }) => {
  ...
  return (
    <section ref={heroRef} className="relative h-screen w-full bg-transparent text-white overflow-hidden">
      <div ref={contentRef} className="absolute top-[15vh] left-1/2 transform -translate-x-1/2 w-full max-w-[600px] px-4 text-center flex flex-col items-center gap-6 will-[opacity]">
